...
import com.qbw.oj.model.vo.QuestionCommentVO;
import com.qbw.oj.service.QuestionCommentService;
import com.qbw.oj.mapper.QuestionCommentMapper;
...
public class QuestionCommentServiceImpl extends ServiceImpl<QuestionCommentMapper, QuestionComment>
    ...
    public int deleteCommentById(QuestionComment questionComment, User loginUser) {
        //只有自己的评论和管理员才可以删除
        if (loginUser == null || !questionComment.getUserId().equals(loginUser.getId()) || !userService.isAdmin(loginUser)) {
